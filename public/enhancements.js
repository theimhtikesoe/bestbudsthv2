...
function processItemsForExcel(receipts) {
  ...
  receipts.forEach(receipt => {
    ...
    items.forEach(item => {
      ...
      const flowerStrains = ['grape soda', 'blue pave', 'devil driver', 'lemon cherry gelato', 'moonbow', 'emergen c', 'tea time', 'silver shadow', 'rozay cake', 'truffaloha', 'the planet of grape', 'crunch berriez', 'big foot', 'honey bee', 'jealousy mintz', 'crystal candy', 'alien mint', 'rocket fuel', 'gold dust', 'darth vader', 'cherry pop tarts', 'white cherry gelato', 'dosidos', 'obama runtz', 'free pina colada', 'fakescotti', 'pina colada', 'thc gummy', 'flower', 'bud', 'pre-roll', 'joint', 'cheese candy', 'vino tinto', 'mac stormper', 'r2d2 fluid', 'planet of the grape'];
